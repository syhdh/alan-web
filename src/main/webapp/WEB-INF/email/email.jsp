...
<head>
    ...
    <title>发送邮件</title>
    <link href="<%=path %>/roundstyle/email/css/demo.css" rel="stylesheet" type="text/css">
    <script src="<%=path %>/roundstyle/email/js/jquery-1.10.2.min.js" type="text/javascript"></script>
    <!--Framework-->
    <script src="<%=path %>/roundstyle/email/js/jquery-1.10.2.min.js" type="text/javascript"></script>
    <script src="<%=path %>/roundstyle/email/js/jquery-ui.js" type="text/javascript"></script>
    <!--End Framework-->
     <script src="<%=path %>/roundstyle/email/js/jquery.ffform.js" type="text/javascript"></script>
